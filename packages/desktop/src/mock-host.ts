...
async function signedCatalogueFixture(): Promise<CatalogueFetchResult> {
  ...
  const index = {
    ...
    entries: [
      { ...common, id: 'journal', name: 'Journal', version: '1.2.0', description: 'Private daily notes with end-to-end local storage.', license: 'MIT', category: 'Productivity', url: 'https://journal.appliance.zip', digest: `sha256:${'1'.repeat(64)}` },
      { ...common, id: 'photos', name: 'Photos', version: '3.1.2', description: 'Self-hosted photo library with on-device face grouping.', license: 'GPL-3.0', category: 'Media', url: 'https://photos.appliance.zip', digest: `sha256:${'2'.repeat(64)}` },
      { ...common, id: 'reader', name: 'Reader', version: '0.14.0', description: 'RSS and newsletter reader, offline-first.', license: 'MIT', category: 'Productivity', url: 'https://reader.appliance.zip', digest: `sha256:${'3'.repeat(64)}` },
      { ...common, id: 'bookmarks', name: 'Bookmarks', version: '2.0.3', description: 'Link archive with full-page snapshots and tags.', license: 'Apache-2.0', category: 'Productivity', url: 'https://bookmarks.appliance.zip', digest: `sha256:${'4'.repeat(64)}` },
      { ...common, id: 'metrics', name: 'Metrics', version: '1.8.0', description: 'Private dashboards for local service data.', license: 'MIT', category: 'Data', url: 'https://metrics.appliance.zip', digest: `sha256:${'5'.repeat(64)}` },
      { ...common, id: 'toolbox', name: 'Toolbox', version: '5.2.1', description: 'Developer utilities in an isolated workspace.', license: 'AGPL-3.0', category: 'Dev tools', url: 'https://toolbox.appliance.zip', digest: `sha256:${'6'.repeat(64)}` },
      { ...common, id: 'paid-hidden', name: 'Paid Hidden', version: '1.0.0', description: 'This must never enter rendered state.', license: 'MIT', category: 'Data', url: 'https://paid-hidden.appliance.zip', digest: `sha256:${'7'.repeat(64)}`, paid: true },
    ],
  };
